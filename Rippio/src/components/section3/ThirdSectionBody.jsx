import '../../css/thirdSectionBody.css'

export function ThirdSectionBody() {
    return (
        <section className='thirdSection'>
            <section className="mostSearched">
                ...
                <section className="mostSearched-content-items">
                    ...
                    <div className="mostSearched-item"><p>Encebollado</p></div>
                    <div className="mostSearched-item"><p>pizza</p></div>
                    <div className="mostSearched-item"><p>Empanadas</p></div>
                    <div className="mostSearched-item"><p>Arroz con pollo</p></div>
