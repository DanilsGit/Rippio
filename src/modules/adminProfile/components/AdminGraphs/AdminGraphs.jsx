    ...
    return (
        <section className='admin_graphs_section'>
            ...
            <div className='admin_graphs_container'>
                <GraphWithTitle title='Restaurantes populares' data={popularRestaurants} />
                ...
                <GraphWithTitle title='Productos más vendidos' data={mostSoldProducts} />
                <GraphWithTitle title='Categorías más vendidas' data={mostSoldCategories} />
            </div>
        </section >
    )
}    